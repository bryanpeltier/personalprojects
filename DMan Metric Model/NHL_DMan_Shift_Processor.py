...
def build_sharks_2425_chart():
    """
    Builds a chart and returns a table both containing the names, numbers, average time for a zone clearance, and percentage of shifts where there were no successful d-zone clearances for each defenseman on the '24-'25 San Jose Sharks.
    ...
    #Create dictionary for each defenseman on the team with their number as the key and name as the value
    ...
    #Create dictionary for each defenseman's metrics with their number as the key and a tuple to hold metrics as the value
